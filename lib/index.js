...
prompt.get(['projectname', 'git'], function (err, result) {
  if (err) { return onErr(err); }
  console.log('Command-line input received:');
  console.log('  Project Name: ' + result.projectname);
  console.log('  Would you like to use GIT: ' + result.git);
  ...
  //install git
  if (result.git === 'y' || result.git === 'Y' || result.git === 'yes' || result.git === 'Yes') {
